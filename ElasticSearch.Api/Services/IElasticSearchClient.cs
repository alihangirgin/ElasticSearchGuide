...
namespace ElasticSearch.Api.Services
{
    public interface IElasticSearchClient
    {
        ...
        Task<IEnumerable<T>?> MatchAllQueryAsync<T>(string indexName) where T : IEntity;
        Task<IEnumerable<T>?> MatchAllWithPaginationQueryAsync<T>(string indexName, int pageSize, int pageNumber, string sortField, bool ascending) where T : IEntity;
        ...
        Task<IEnumerable<T>?> TermQueryAsync<T>(string indexName, string fieldName, string value, bool caseInsensitive) where T : IEntity;
        Task<IEnumerable<T>?> TermsQueryAsync<T>(string indexName, string fieldName, string[] values) where T : IEntity;
        Task<IEnumerable<T>?> PrefixQueryAsync<T>(string indexName, string fieldName, string prefix) where T : IEntity;
        Task<IEnumerable<T>?> NumberRangeQueryAsync<T>(string indexName, string fieldName, double? from, double? to) where T : IEntity;
        Task<IEnumerable<T>?> DateRangeQueryAsync<T>(string indexName, string fieldName, DateTime? from, DateTime? to) where T : IEntity;
        Task<IEnumerable<T>?> WildcardQueryAsync<T>(string indexName, string fieldName, string wildcardPattern) where T : IEntity;
        Task<IEnumerable<T>?> FuzzyQueryAsync<T>(string indexName, string fieldName, string value, int? fuzziness) where T : IEntity;
        Task<IEnumerable<T>?> MatchQueryAsync<T>(string indexName, string fieldName, string value) where T : IEntity;
